...
namespace NewTest
{
    public class StableTest
    {
        ...
        public StableTest(ITestOutputHelper output)
        {
            this.output = output;
        }
        ...
        {
            test_string1(number, source, target, acient);
        }
        ...
        public void test_s(string source, string target)
        {
        ...
        void test_word(string source,
            ...
            bool ancient = false)
        {
            test_string1(-1, source, target, ancient);
        }
    ...
    out source);
        ...
        internal static void Compare(string s1, string s2)
        {
